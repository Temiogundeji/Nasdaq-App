...
export const stockAPI = {
  ...
  // stockDetails:'https://api.polygon.io/v1/meta/symbols/AAPL/company?&apiKey=MnkF9A6CCEkkkppQiVNZGMySJEc2b_yI',
  // stockPrevDay: 'https://api.polygon.io/v2/aggs/ticker/AAPL/prev?adjusted=true&apiKey=MnkF9A6CCEkkkppQiVNZGMySJEc2b_yI'
  stockPrevDay: (ticker) =>
